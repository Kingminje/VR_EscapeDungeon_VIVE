...
public class CameraShake : MonoBehaviour
{
    ...
    public Quaternion crrentRotate;
    ...
    {
        crrentRotate = transform.localRotation;
    ...
    private IEnumerator Shake()
    {
        ...
        transform.localRotation = crrentRotate;/*Quaternion.identity;*///Set the local rotation to 0 when done, just to get rid of any fudging stuff.
        isRunning = false;
    }
}